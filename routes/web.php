...
Route::get('edit-post/{id}',[HomeController::class,'editPost'])->name('editPost');
Route::post('update-post/{id}',[HomeController::class,'updatePost'])->name('updatePost');
Route::get('delete-post/{id}',[HomeController::class,'deletePost'])->name('deletePost');
